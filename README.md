...
- **VarAC Chat**: Chat terminal and VMail using VARA protocol.  Requires installer to be downloaded to ~/add-ons/wine prior to running script.
                            (if you use VarAC 12 it is supported out of the box, VarAC 13 requires running fix-varac-13.sh in your home directory to update .NET
